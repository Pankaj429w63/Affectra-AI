...
def run_exp5a_training(epochs: int):
    ...
    print("\n==================================================")
    print(f"6. {epochs}-EPOCH SANITY CHECK (EXP 5A CORRECT)")
    print("==================================================")
...
if __name__ == "__main__":
    # Ensure no old checkpoints are accidentally loaded by setting max_epochs=3
    run_exp5a_training(epochs=3)
